...
@pytest.mark.parametrize(
    "message",
    [
        {"ReceiptHandle": "rh-missing-body"},
        {"ReceiptHandle": "rh-none-body", "Body": None},
        {"ReceiptHandle": "rh-empty-body", "Body": ""},
    ],
)
def test_run_once_missing_or_empty_body_does_not_ack(message):
    """Missing/empty Body becomes '{}' via `or`, fails JobMessage validation, must not delete."""
    sqs = MagicMock()
